...
$usuario = "postgres";
$contrasena= "GJ.m~7k;TZAe=#-t"; 
$servidor = "172.17.52.15:5432";
$driver = "postgres";
$db = "quipux_comunidad";

$usuario_bodega = "postgres";
$contrasena_bodega = "GJ.m~7k;TZAe=#-t";
$servidor_bodega = "172.17.52.15:5432";
...
$path_ciudadanos = "/var/www/html/sgdq/bodega/ciudadanos";
...
$amd_email = "quipux_epm@movidelnor.gob.ec";
// email de la cuenta de soporte
$cuenta_mail_soporte = "quipux_epm@movidelnor.gob.ec";
// email de la cuenta desde la que se enviarán los recordatorios a los usuarios
$cuenta_mail_envio = "quipux_epm@movidelnor.gob.ec";

// Configuración para la conexión con otros servidores adicionales
$nombre_servidor="https://sgdocumental.movidelnor.gob.ec";
...
$servidor_firma = "http://172.17.52.15/firma";

$servidor_viajes = "http://nombre_servidor_viajes";

$servidor_pdf = "http://172.17.52.15/html_a_pdf";
