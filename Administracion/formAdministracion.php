...
<?php
    ...
    if($_SESSION["tipo_usuario"]==1) { // Valido si es funcionario publico
        ...
        if($_SESSION["usua_codi"]==0) {
            ...
            echo dibujar_opcion_menu("migrar_bodega/completar_bodega.php", "Verificar y corregir inconsistencias en la bodega", "Opci&oacute;n para verificar el estado de la bodega");
